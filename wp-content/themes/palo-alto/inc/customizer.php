...
function wpkube_customize_register( $wp_customize ) {
	...
	$wp_customize->get_section('colors')->title = __('Background & Sidebar Colors', 'palo-alto');
	$wp_customize->get_setting( 'background_color' )->priority= 1;

	/* Section : Post setting
	---------------------------------*/
	$wp_customize->add_section( 'post', array(
			'title'    => __( 'Post Setting', 'palo-alto' ),
			'priority' => 40,
	) );
	...
	$wp_customize->add_section( 'footer', array(
			'title'    => __( 'Footer Setting', 'palo-alto' ),
			'priority' => 42,
	) );
	...
	$wp_customize->add_section( 'primary_menu_colors', array(
			'title'    => __( 'Primary Menu Colors', 'palo-alto' ),
			'priority' => 37,
	) );
	...
	$wp_customize->add_section( 'content_colors', array(
			'title'    => __( 'Main Content Colors', 'palo-alto' ),
			'priority' => 38,
	) );
	...
	$wp_customize->add_section( 'typography', array(
			'title'    => __( 'Typography Setting', 'palo-alto' ),
			'priority' => 39,
	) );
...
function wpkube_customize_items( $settings ) {
	...
	$default_color_options = array(
		...
		'content_link_color' => '#5C6BC0',
		'content_meta_color' => '#bbbbbb',
		'content_border_color' => '#dddddd',
		'content_section_title_color' => '#0e1430',	
		'heading_font' => 'Lato__100,100italic,300,300italic,400,400italic,700,700italic,900,900italic',
		'heading_font_style' => 'normal',
		'heading_font_weight' => '700',
		'body_font' => 'Lato__100,100italic,300,300italic,400,400italic,700,700italic,900,900italic',
		'menu_font' => 'Lato__100,100italic,300,300italic,400,400italic,700,700italic,900,900italic',
	...
	$settings[] = array(
		'id' => 'logo_text', 
		'default' => true,
		'label'    => __( 'Show site title as logo', 'palo-alto' ),
	...
	$settings[] = array(
		'id' => 'tagline_text', 
		'default' => false,
		'label'    => __( 'Show tagline', 'palo-alto' ),
		'section'  => 'title_tagline',
		'control'     => 'checkbox',
		'priority' => 35,
	);
	...
	$settings[] = array(
		'id' => 'share_buttons', 
		'default' => false,
		'label'    => __( 'Show share buttons', 'palo-alto' ),
		'section'  => 'post',
		'control'     => 'checkbox',
		'priority' => 30,
	);
	...
	$settings[] = array(
		...
		'transport' => 'refresh',
		'control' => 'url',
		'label' => __('Facebook URL', 'palo-alto'),
		'section' => 'footer',
	);
     /* Facebook url */
	$settings[] = array(
		...
		'transport' => 'refresh',
		'control' => 'url',
		'label' => __('Twitter URL', 'palo-alto'),
		'section' => 'footer',
	);
     /* Facebook url */
	$settings[] = array(
		...
		'transport' => 'refresh',
		'control' => 'url',
		'label' => __('Instagram URL', 'palo-alto'),
		'section' => 'footer',
	);
     /* Facebook url */
	$settings[] = array(
		...
		'transport' => 'refresh',
		'control' => 'url',
		'label' => __('Pinterest URL', 'palo-alto'),
		'section' => 'footer',
	);
	...
	$settings[] = array(
		...
		'transport' => 'refresh',
		'control' => 'textarea',
		'label' => __('Credit text on footer', 'palo-alto'),
		'section' => 'footer',
	);
    /* text on footer */
	$settings[] = array(
		...
		'transport' => 'refresh',
		'control' => 'textarea',
		'label' => __('Text on footer', 'palo-alto'),
		'section' => 'footer',
	);
	...
	$settings[] = array(
		...
		'transport' => 'postMessage',
		'control' => 'color', 
		'label'   => __( 'Link color', 'palo-alto' ),
		'section' => 'colors',
		'priority' => 2,
		'apply_css' => array (
			array(
				'selector' => '#primary .entry-title a:hover',
				'property' => 'color',
			)
		),
	);
	...
	$settings[] = array(
		...
		'transport' => 'postMessage',
		'control' => 'color', 
		'label'   => __( 'Border color', 'palo-alto' ),
		'section' => 'colors',
		'priority' => 4,
		'apply_css' => array (
			array(
				'selector' => '.entry-title, #primary input[type=text], #primary input[type=email], #primary input[type=password], #primary textarea',
	...
	$settings[] = array(
		...
		'transport' => 'postMessage',
		'control' => 'color', 
		'label'   => __( 'Primary menu link color', 'palo-alto' ),
	...
	$settings[] = array(
		...
		'transport' => 'postMessage',
		'control' => 'color', 
		'label'   => __( 'Primary menu link hover color', 'palo-alto' ),
		'section' => 'primary_menu_colors',
		'priority' => 6,
		'apply_css' => array (
			array(
	...
	$settings[] = array(
		...
		'transport' => 'postMessage',
		'control' => 'color', 
		'label'   => __( 'Content background color', 'palo-alto' ),
	...
	$settings[] = array(
		...
		'transport' => 'postMessage',
		'control' => 'color', 
		'label'   => __( 'Main content font color', 'palo-alto' ),
		'section' => 'content_colors',
		'priority' => 2,
		'apply_css' => array (
			array(
	...
	$settings[] = array(
		...
		'transport' => 'postMessage',
		'label'   => __( 'Main content link color', 'palo-alto' ),
		'control' => 'color', 
		'section' => 'content_colors',
		'priority' => 3,
		'apply_css' => array (
			...
			array(
				'selector' => '#primary button, #primary input[type="button"], #primary input[type="reset"], #primary input[type="submit"], .entry-meta .post-cats a',
				'property' => 'background-color',
			),
		),
	);
	...
	$settings[] = array(
		...
		'transport' => 'postMessage',
		'control' => 'color', 
		'label'   => __( 'Main content meta text color', 'palo-alto' ),
		'section' => 'content_colors',
		'priority' => 4,
		'apply_css' => array (
			array(
	...
	$settings[] = array(
		...
		'transport' => 'postMessage',
		'control' => 'color', 
		'label'   => __( 'Borders color', 'palo-alto' ),
		'section' => 'content_colors',
		'priority' => 5,
		'apply_css' => array (
			array(
	...
	$settings[] = array(
		...
		'transport' => 'postMessage',
		'control' => 'color', 
		'label'   => __( 'Section title font color', 'palo-alto' ),
		'section' => 'content_colors',
		'priority' => 6,
		'apply_css' => array (
			array(
				'selector' => '.section-title, .slider-header h2, #primary .section-title a, #reply-title, .section-title:after, #reply-title:after',
				'property' => 'color',
			)
		),
	);
	...
	$settings[] = array(
		...
		'label'    => __( 'Heading font', 'palo-alto' ),
		'section'  => 'typography',
		'priority' => 1,
		'control'     => 'select',
