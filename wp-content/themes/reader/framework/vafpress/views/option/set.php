				...
				<div id="vp-menus" class="vp-menus">
					<ul class="vp-menu-level-1">
						...
						<?php endif; ?>
							...
							<a href="#<?php echo esc_html($menu->get_name()); ?>" class="vp-js-menu-dropdown vp-menu-dropdown">
							<?php else: ?>
							<a href="#<?php echo esc_html($menu->get_name()); ?>" class="vp-js-menu-goto vp-menu-goto">
							<?php endif; ?>
								<?php
								$icon = $menu->get_icon();
							...
							<ul class="vp-menu-level-2">
								...
								<li>
								<?php endif; ?>
									<a href="#<?php echo esc_html($submenu->get_name()); ?>" class="vp-js-menu-goto vp-menu-goto">
										<?php
