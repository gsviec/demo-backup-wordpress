...
<div class="customEditor">
	...
	<textarea class="vp-input vp-js-wpeditor" id="<?php echo esc_attr($name) . '_ce'; ?>"  data-vp-opt="<?php echo esc_attr($opt); ?>" rows="10" cols="50" name="<?php echo esc_attr($name); ?>" rows="3"><?php echo esc_textarea($value); ?></textarea>
</div>
