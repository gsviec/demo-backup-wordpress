...
/*
	...
	Tags: categories, comments, drafts, pages, posts, recent comments, recent posts, statistics, stats, tags, users
	Author: Jeff Starr
...
function sbs_render_form() {
	...
	<style type="text/css">
		...
		#mm-plugin-options h1 small { font-size: 60%; color: #777; }
	...
	<div id="mm-plugin-options" class="wrap">
		...
		<form method="post" action="options.php">
			...
			<div id="mm-credit-info">
				...
				<a target="_blank" href="http://monzillamedia.com/" title="<?php esc_attr_e('Obsessive Web Design &amp; Development', 'simple-blog-stats'); ?>">Monzilla Media</a>
			</div>
